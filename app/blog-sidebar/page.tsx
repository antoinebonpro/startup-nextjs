...
export const metadata: Metadata = {
  title: "Blog Details Page | Free Next.js Template for Green Lighthouse and SaaS",
  description: "This is Blog Details Page for Green Lighthouse Nextjs Template",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-sm bg-white dark:shadow-none">
                ...
                <div className="flex flex-wrap px-8 py-6">
                  ...
                  <TagButton text="Green Lighthouse" />
